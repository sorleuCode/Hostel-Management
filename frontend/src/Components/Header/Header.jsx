...
const Header = () => {
    ...
    const logOutUser = async () => {
        try {
            await axios.post("https://hostel-management-3ztc.vercel.app/admin/logout", null, {
        ...
        <>
            {navToggle && (
                <div className="mobile-sidebar">
                    <HeaderSideBar items={items} setNavToggle={setNavToggle} />
                </div>
            )}
            <header>
                <nav className="navigation --flex-between">
                    ...
                    <div className="logo">
                        ...
                        {navToggle ? <FaTimes className="sidebar-toggle-icon" onClick={() => setNavToggle(false)} /> :

                            <FaBars className="sidebar-toggle-icon" onClick={() => setNavToggle(true)} />}
